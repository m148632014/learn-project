package org.mfm.learn.rabbitmq.utils;
...
public class JsonMapper {
    ...
    public String toJson(Object object) {
        ...
        try {
            ...
            JsonMapper.log.error("write to json string error:" + object, e);
            return null;
        }
    }
    ...
    public String toJson(Class<?> viewClass, Object object) {
        ...
        try {
            ...
            JsonMapper.log.warn("write to json string error:" + object, e);
            return null;
        }
    }
    ...
    public <T> T fromJson(String jsonString, Class<T> clazz) {
        ...
        try {
            ...
            JsonMapper.log.error("json转换异常." + jsonString + "-----" + clazz, e);
            return null;
        }
    }
    ...
    public <T> T fromJson(String jsonString, JavaType javaType) {
        ...
        try {
            ...
            JsonMapper.log.error("parse json string error:" + jsonString, e);
            return null;
        }
    }
    ...
    public <T> T update(String jsonString, T object) {
        try {
            return (T) this.mapper.readerForUpdating(object)
                .readValue(jsonString);
        } catch (JsonProcessingException e) {
            JsonMapper.log.warn("update json string:" + jsonString
